...
const Hero = () => {
  ...
  return (
    <section className="relative w-full min-h-[100vh] sm:min-h-[85vh] flex items-center justify-center bg-gradient-to-b from-black via-gray-900 to-black overflow-hidden">
