...
const Hero = () => {
  ...
  return (
    <section className="relative w-full min-h-[100vh] flex items-center justify-center bg-gradient-to-b from-black via-gray-900 to-black overflow-hidden">
      <div ref={mountRef} className="absolute inset-0 w-full h-full z-0" />
      <div className="relative z-10 flex flex-col lg:flex-row items-center justify-center w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16 gap-6 sm:gap-8 lg:gap-20">
        ...
        <div className="flex-shrink-0 flex items-center justify-center order-2 lg:order-1">
          <div className="relative group">
            ...
            <div className="relative w-40 h-40 sm:w-48 sm:h-48 lg:w-80 lg:h-80 rounded-full border-4 border-gray-300/30 shadow-2xl flex items-center justify-center bg-gradient-to-br from-gray-800 to-gray-900 overflow-hidden backdrop-blur-sm">
        ...
        <div className="flex-1 flex flex-col justify-center items-center lg:items-start text-center lg:text-left order-1 lg:order-2">
          <div className="mb-4 sm:mb-6">
            <h1 className="text-2xl sm:text-3xl lg:text-6xl font-bold text-white mb-2 sm:mb-3 lg:mb-4 leading-tight">
              Hi, I'm <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">Ratul Banik</span>
            </h1>
            <h2 className="text-base sm:text-lg lg:text-2xl font-medium text-gray-300 mb-3 sm:mb-4 lg:mb-6">
              MERN Stack Developer & Competitive Programmer
            </h2>
          </div>
          
          <p className="text-sm sm:text-base lg:text-lg text-gray-300 mb-4 sm:mb-6 lg:mb-8 max-w-2xl leading-relaxed px-2 sm:px-0">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-4 sm:mb-6 lg:mb-8 w-full sm:w-auto">
            <a
              href="https://www.linkedin.com/in/ratul-banik1204/"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 sm:gap-3 px-4 sm:px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-medium rounded-lg hover:from-blue-700 hover:to-purple-700 transition-all duration-300 transform hover:scale-105 shadow-lg w-full sm:w-auto text-sm sm:text-base"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 sm:gap-3 px-4 sm:px-6 py-3 border-2 border-gray-600 text-gray-300 font-medium rounded-lg hover:border-gray-400 hover:text-white transition-all duration-300 transform hover:scale-105 w-full sm:w-auto text-sm sm:text-base"
            >
              <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="currentColor" viewBox="0 0 24 24">
