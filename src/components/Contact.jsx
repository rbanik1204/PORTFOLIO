...
import { FaLinkedin, FaGithub, FaTwitter, FaEnvelope, FaPhone, FaMapPin } from "react-icons/fa";
...
const Contact = () => {
  ...
  // Build API base:
  // 1) prefer explicit injected VITE_API_URL
  // 2) otherwise use sensible default based on mode
  const API_BASE =
    (import.meta.env.VITE_API_URL && import.meta.env.VITE_API_URL.trim()) ||
    (import.meta.env.MODE === "production"
      ? "https://portfolio-gh2m.onrender.com"
      : "http://localhost:5000");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok && data?.success) {
        ...
        const msg = data?.message || `Failed to send (status ${response.status})`;
        setError(msg);
      }
    } catch (err) {
      ...
      <div className="w-full max-w-6xl mx-auto z-10 relative">
            ...
            <div className="glass-card rounded-2xl p-6 sm:p-8">
              ...
              <div className="space-y-4 sm:space-y-6">
                <div className="flex items-center gap-3 sm:gap-4">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <a href="mailto:ratulbanik1204@gmail.com" className="text-white hover:text-blue-400 transition-colors font-medium text-sm sm:text-base break-all">
              ...
              <div className="mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-white/10">
                ...
                <div className="flex gap-3 sm:gap-4">
                  <a href="https://www.linkedin.com/in/ratul-banik1204/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 sm:w-12 sm:h-12 bg-blue-500/20 hover:bg-blue-500/30 rounded-lg flex items-center justify-center text-blue-400 hover:text-blue-300 transition-all duration-300">
                    <FaLinkedin className="text-lg sm:text-xl" />
                  </a>
                  <a href="https://github.com/rbanik1204" target="_blank" rel="noopener noreferrer" className="w-10 h-10 sm:w-12 sm:h-12 bg-gray-500/20 hover:bg-gray-500/30 rounded-lg flex items-center justify-center text-gray-400 hover:text-gray-300 transition-all duration-300">
                    <FaGithub className="text-lg sm:text-xl" />
                  </a>
                  <a href="https://twitter.com/ratulbanik1204" target="_blank" rel="noopener noreferrer" className="w-10 h-10 sm:w-12 sm:h-12 bg-blue-400/20 hover:bg-blue-400/30 rounded-lg flex items-center justify-center text-blue-400 hover:text-blue-300 transition-all duration-300">
          ...
          <div className="glass-card rounded-2xl p-6 sm:p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
              <div>
                ...
                <input
                  id="name"
                  className="w-full p-3 sm:p-4 rounded-lg bg-white/5 border border-white/10 text-white placeholder-gray-400"
                  type="text"
                  name="name"
              ...
              <div>
                ...
                <textarea
                  id="message"
                  className="w-full p-3 sm:p-4 rounded-lg bg-white/5 border border-white/10 text-white placeholder-gray-400 resize-none"
                  name="message"
              ...
              <button
                type="submit"
                disabled={isSubmitting}
                className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold py-3 sm:py-4 px-6 rounded-lg hover:from-blue-700 hover:to-purple-700 transition-all duration-300 transform hover:scale-105 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed text-base"
              >
                {isSubmitting ? (
        ...
        {showThankYou && (
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div className="glass-card rounded-2xl p-6 sm:p-8 max-w-md w-full mx-4 text-center">
